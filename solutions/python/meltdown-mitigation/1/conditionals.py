...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    condition_one = temperature < 800
    condition_two = neutrons_emitted > 500
    condition_three = (temperature * neutrons_emitted) < 500000
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if current_power < low_limit:
        return "LOW"
    elif current_power < high_limit:
        return "NORMAL"
    else:
        return "DANGER"
